...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'province_id', type: 'integer', nullable: true, example: 8),
        new OA\Property(property: 'city_id', type: 'integer', nullable: true, example: 760),
        new OA\Property(property: 'address', type: 'string', nullable: true, example: 'خیابان ولیعصر، کوچه ۵، پلاک ۱۲'),
        new OA\Property(property: 'province', ref: '#/components/schemas/Province', nullable: true),
